...
def wangzhangplot(fname):
	...
	'''print("non-A: ", wangzhangcalc(seqarr, seqlen, 'A'))
	#wangzhangcalc(seqarr, seqlen, 'A')
	print("non-G: ", wangzhangcalc(seqarr, seqlen, 'A'))
	#wangzhangcalc(seqarr, seqlen, 'G')
	print("non-C: ", wangzhangcalc(seqarr, seqlen, 'A'))
...
def wangzhangcalc(seqarr, seqlen, base):
	...
	print(np.linalg.eigvals(lbyl_mat).max() + np.linalg.eigvals(lbyl_mat).min())
